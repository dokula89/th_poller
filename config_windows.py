...
# Address Match and Insert DB windows
# This file is part of the split config_utils.py

from config_core import *
from config_core import *
# Note: Uses OldCompactHUD from config_hud_part*.py
    ...
    def run_for_address(row_id, google_address, preloaded_ga_id=None):
        ...
        try:
            ...
            if place_id_to_use:
                ...
                url = f"http://localhost/step5/find_or_create_place.php?place_id={encoded_place_id}&html=yes&debug=1"
